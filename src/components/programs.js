    ...
    <div id="programs" className='flex flex-col items-center bg-white text-bordeaux-black px-4 py-16 lg:p-24'>
        ...
        <div className='shadow-[0_6px_16px_rgb(0,0,0,0.2)] mb-12 xl:mb-24 flex flex-col bg-bordeaux-brown p-8 rounded-xl justify-center items-center md:flex-row'>
            ...
            <div className='w-full md:w-1/2 lg:w-[30%] relative'>
                <div className='px-6 text-center text-white absolute bottom-2 left-1/2 transform -translate-y-[5%] -translate-y-[30%] -translate-x-1/2 xl:-translate-y-[10%] p-4 bg-bordeaux-slate backdrop-blur-sm bg-opacity-30 rounded-xl'>
        ...
        <div className='shadow-[0_6px_16px_rgb(0,0,0,0.2)] mb-12 xl:mb-24 flex flex-col bg-bordeaux-brown p-8 rounded-xl justify-center items-center md:flex-row'>
            ...
            <div className='w-full md:w-1/2 lg:w-[30%] relative'>
                <div className='px-6 text-center absolute text-white bottom-2 left-1/2 transform -translate-y-[5%] -translate-y-[30%] -translate-x-1/2 xl:-translate-y-[10%] p-4 bg-bordeaux-slate backdrop-blur-sm bg-opacity-30 rounded-xl'>
        ...
        <div className='shadow-[0_6px_16px_rgb(0,0,0,0.2)] mb-8 xl:mb-0 flex flex-col bg-bordeaux-brown p-8 rounded-xl justify-center items-center md:flex-row'>
