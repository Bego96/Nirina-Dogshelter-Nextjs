...
export default function Supporters() {
  return (
    <div className='bg-orange px-4 py-16 lg:px-20 lg:py-28 mt-20 lg:mt-36 text-bordeaux-slate'>
        <h2 className='text-center font-semibold text-4xl xl:text-6xl mb-20'>We are Supported by</h2>
        <div className="p-4 grid md:grid-cols-2 xl:grid-cols-3 gap-8 max-w-screen mx-auto">
            <div className="rounded-xl p-4  flex flex-col bg-white h-96 2xl:flex-row justify-center items-center gap-4" >
                ...
                <div className="w-maxWidth text-center 2xl:text-left">
